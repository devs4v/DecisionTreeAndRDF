'''	randomcrossvalidation.py
#	Author			: Shivam Chaturvedi
#	Last Modified	: 08:46 PM, 9th September 2013
...
for j in range(k):
	...
	testInstances = []
	randomInstances = [int(random()*x) for n in range(fold)]
	print len(randomInstances)
	for i in range(x):
		if i not in randomInstances:
